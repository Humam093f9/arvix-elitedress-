...
var I18N_DICT = {
  ar: {
    ...
    'nav.contact_us_label': 'تواصل معنا',
    'nav.cart_aria': 'سلة المشتريات',
    'nav.search_aria': 'بحث بالمتجر',
    'nav.wishlist_aria': 'المفضّلة',
    'nav.menu_aria': 'فتح القائمة',
    'nav.brand_aria': 'ELITEDRESS — الصفحة الرئيسية',
    'nav.theme_aria': 'تبديل الوضع الفاتح/الغامق',
    ...
    'order.settings_error': 'تعذّر الاتصال بإعدادات المتجر حاليًا. تأكدي إنك تستخدمين رابط متجرك الكامل، أعيدي تحميل الصفحة وحاولي مرة ثانية، أو تواصلي معنا مباشرة.',
    'cart.title': 'سلة المشتريات',
    'cart.page_title': 'سلة المشتريات — ELITEDRESS',
    'cart.eyebrow': 'مشترياتك',
    'cart.loading': 'جاري تحميل السلة...',
    'cart.empty': 'السلة فاضية حاليًا.',
    'cart.remove': 'إزالة',
    'cart.clear': 'إفراغ السلة',
    'cart.checkout': '✷ إتمام الطلب عبر واتساب',
    'cart.total_label': 'الإجمالي',
    'cart.qty_label': 'الكمية',
    'cart.close_aria': 'إغلاق السلة',
    'cart.msg_intro': 'طلب جديد يتضمن:',
    'wishlist.title': 'المفضّلة',
    'wishlist.page_title': 'المفضّلة — ELITEDRESS',
    'wishlist.eyebrow': 'الفساتين المحفوظة',
    'wishlist.loading': 'جاري تحميل المفضّلة...',
    'wishlist.empty': 'ما ضفتي أي فستان للمفضّلة بعد.',
    'wishlist.view_product': 'عرض المنتج',
    'search.placeholder': 'دوّري عن فستان...',
    'search.aria_submit': 'بحث',
    ...
    'filters.color_label': 'اللون',
    'filters.size_label': 'المقاس',
    ...
    'product.color_default': 'افتراضي',
    'product.fabrics': 'الأقمشة',
    'product.sizes_available': 'المقاسات المتوفرة',
    'product.size_guide': 'دليل المقاسات',
    'product.size_region_label': 'نظام المقاس',
    'product.size_guide_syria': 'سوري / أوروبي',
    'product.size_guide_letter': 'الحرف',
    ...
    'product.add_to_cart': 'أضيفي للسلة',
    'product.added_to_cart': '✓ تمت الإضافة',
  ...
  en: {
    ...
    'nav.contact_us_label': 'Contact Us',
    'nav.cart_aria': 'Shopping cart',
    'nav.search_aria': 'Search the store',
    'nav.wishlist_aria': 'Wishlist',
    'nav.menu_aria': 'Open menu',
    'nav.brand_aria': 'ELITEDRESS — Home',
    'nav.theme_aria': 'Toggle light/dark mode',
    ...
    'order.settings_error': "Couldn't connect to the store settings right now. Make sure you're using your full store link, reload the page and try again, or contact us directly.",
    'cart.title': 'Shopping Cart',
    'cart.page_title': 'Shopping Cart — ELITEDRESS',
    'cart.eyebrow': 'Your Selections',
    ...
    'cart.msg_intro': 'New order including:',
    'wishlist.title': 'Wishlist',
    'wishlist.page_title': 'Wishlist — ELITEDRESS',
    'wishlist.eyebrow': 'Saved Dresses',
    'wishlist.loading': 'Loading your wishlist...',
    'wishlist.empty': "You haven't added any dresses to your wishlist yet.",
    'wishlist.view_product': 'View product',
    'search.placeholder': 'Search for a dress...',
    'search.aria_submit': 'Search',
    ...
    'filters.color_label': 'Color',
    'filters.size_label': 'Size',
    ...
    'product.color_default': 'Default',
    'product.fabrics': 'Fabrics',
    'product.sizes_available': 'Available Sizes',
    'product.size_guide': 'Size Guide',
    'product.size_region_label': 'Size system',
    'product.size_guide_syria': 'Syrian / EU',
    'product.size_guide_letter': 'Letter',
